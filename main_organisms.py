...
def main():
    ...
    all_values,train_mask,val_mask,test_mask,shuffled_idx , gos, sequences,_ = load_data_org(DATA_ROOT=args["DATA_ROOT"], FUNCTION=args["function"],
    ...
    # 1. 创建文件对象F
    f = open('res/res_PFGCN_'+args["function"]+'_'+args["org"]+'.csv', 'w', encoding='utf-8', newline="")
    # 2. 基于文件对象构建 csv写入对象
